                ...
                <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                    ...
                    <div class="mb-8">
                        ...
                        <a 
                            ...
                            class="nav-link {{ request()->routeIs('guests.*') ? 'nav-link-active' : '' }}"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        {{-- Gift Accounts --}}
                        <a 
                            href="{{ route('gift-accounts.index') }}" 
                            class="nav-link {{ request()->routeIs('gift-accounts.*') ? 'nav-link-active' : '' }}"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"/>
                            </svg>
                            <span>Gift Accounts</span>
                        </a>

                        {{-- Analytics --}}
                        <a 
                            href="{{ route('analytics.index') }}" 
                            class="nav-link {{ request()->routeIs('analytics.*') ? 'nav-link-active' : '' }}"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
